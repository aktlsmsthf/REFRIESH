...
public class IngredientSearch2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingredient_search2);
        ...
        final ListViewAdapter4 adapter= new ListViewAdapter4() ;
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                            ...
                                            public void onItemClick(AdapterView parent, View v, int position, long id) {
                                                // get item
                                                ListViewItem4 item = (ListViewItem4) parent.getItemAtPosition(position) ;
                                                et = mEditTextName.getText().toString();
                                                String kname = item.getK();
                                                et += kname + " ";
                                                mEditTextName.setText(et);
                                            }
                                        }
        );
    }
    ...
    private class InsertData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(IngredientSearch2.this,
        ...
        protected String doInBackground(String... params) {
            ...
            String serverURL = "http://110.76.95.167:7777/ingredient.php";
            String postParameters = "ingredient=" + name;
